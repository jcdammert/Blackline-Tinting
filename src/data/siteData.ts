...
export const faqItems = [
  { q: 'How long does a window tint installation take?', a: 'Most standard vehicles take 1.5 to 3 hours depending on the number of windows and the complexity of the job. We come to you, so you can go about your day at home or at work while we handle everything.' },
  { q: 'How long does tint take to cure after installation?', a: "In South Florida's heat, tint typically cures within 3 to 5 days. During this time you may notice small water bubbles or hazy spots — this is completely normal and will clear up on its own. Avoid rolling down your windows during this period." },
  { q: 'What is the difference between regular tint and ceramic tint?', a: "Regular dyed tint darkens your windows and provides basic UV and heat reduction. SunTek ceramic tint uses nano-ceramic technology that blocks significantly more heat and infrared light without any metal in the film, meaning no interference with your phone, GPS, or keyless entry. Ceramic tint is also more fade resistant and performs better in direct sunlight over time." },
  ...
  { q: 'Do you offer any warranties?', a: "Yes. Every installation is backed by SunTek's manufacturer warranty on the film. Warranty coverage varies by film type. Reach out and we can walk you through what applies to the tint you choose." },
  { q: 'Do you tint windshields?', a: "Yes. Technically, any tint on a windshield beyond the AS-1 line is outside Florida's legal limits, but that does not stop most people from doing it. The most common option is a clear or nearly clear ceramic film that blocks heat and UV without changing how your windshield looks at all. Others simply prefer to go darker and are comfortable with that choice. We offer both. Whatever direction you want to go, we will take care of it." },
  { q: 'How do I get the VIP discount?', a: 'Our VIP discount is available to active military, veterans, police officers, firefighters, and EMTs. Just mention your eligibility when booking your appointment or note it in the quote form.' },
  { q: 'Do you offer same week appointments?', a: 'Yes, we offer same week appointments for most services. Availability depends on our current schedule, but we do our best to get you booked quickly. Fill out the quote form or call us directly to check availability.' },
  { q: 'Can I get an exact price before booking?', a: "Absolutely. Fill out our free quote form with your vehicle details and preferred service and we'll send you an exact price — no guesswork, no hidden fees." },
  ...
  { q: 'How does mobile tinting work?', a: "We come to you. Book your appointment online, pick a time that works, and we show up to your location with everything needed to do the job on the spot. No shop visits, no waiting rooms — just professional tinting wherever you are." },
  { q: 'Where do you come to do the job?', a: "We show up at your home, your workplace, or wherever your vehicle is parked. As long as we have reasonable space to work around the vehicle, we can get it done." },
  { q: 'What do I need to do before you arrive?', a: "Just make sure your vehicle is parked in a spot where we have access to all sides. A shaded or covered area is a bonus but not required. We handle everything else." },
  { q: 'What areas do you serve?', a: "We serve Broward County, Miami-Dade County, and Palm Beach County. Not sure if you're in our service area? Reach out and we will confirm." },
  { q: 'What happens if it rains on the day of my appointment?', a: "Rain can affect the installation quality, so if weather is a concern on your scheduled day we will reach out to reschedule at a time that works for you. We want every job done right." },
  ...
  { q: 'Does tint block UV rays?', a: "Yes. SunTek window film blocks a significant amount of harmful UV rays, helping protect your skin and preventing your interior from fading over time. Even lighter shades provide strong UV protection." },
  { q: 'Does tint help with heat?', a: "Yes, significantly. Window film reduces the amount of infrared heat that enters your vehicle, which is especially important in South Florida. Ceramic tint is the most effective at blocking heat without compromising visibility." },
  { q: 'Can tint be removed?', a: "Yes. Old or damaged tint can be professionally removed and replaced. Contact us and we can assess your situation and let you know the best path forward." },
  { q: 'How do I care for my tinted windows?', a: "Wait at least 3 to 5 days after installation before cleaning. Use a soft cloth or microfiber towel with an ammonia free cleaner. Avoid anything abrasive that could scratch the film." },
]
